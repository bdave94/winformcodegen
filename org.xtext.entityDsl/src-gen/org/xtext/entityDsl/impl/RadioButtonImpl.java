 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.entityDsl.impl.RadioButtonImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RadioButtonImpl extends MinimalEObjectImpl.Container implements RadioButton
{
  ...
  {
		return EntityDslPackage.Literals.RADIO_BUTTON;
	}
  ...
  public void setText(String newText)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntityDslPackage.RADIO_BUTTON__TEXT, oldText, text));
	}
  ...
  {
		switch (featureID) {
			case EntityDslPackage.RADIO_BUTTON__TEXT:
				return getText();
		}

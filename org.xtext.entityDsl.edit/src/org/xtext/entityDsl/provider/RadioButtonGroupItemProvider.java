...
/**
 * This is the item provider adapter for a {@link org.xtext.entityDsl.RadioButtonGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RadioButtonGroupItemProvider extends WinFormControlTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RadioButtonGroupItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RadioButtonGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RadioButtonGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((RadioButtonGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RadioButtonGroup_type") :
			getString("_UI_RadioButtonGroup_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.RADIO_BUTTON_GROUP__BUTTONS,
				 EntityDslFactory.eINSTANCE.createRadioButton()));

...
/**
 * This is the item provider adapter for a {@link org.xtext.entityDsl.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityDslPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EntityDslPackage.Literals.ATTRIBUTE__INPUT_TYPE);
			childrenFeatures.add(EntityDslPackage.Literals.ATTRIBUTE__LABEL_TEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.ATTRIBUTE__INPUT_TYPE,
				 EntityDslFactory.eINSTANCE.createWinFormControlType()));

		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.ATTRIBUTE__INPUT_TYPE,
				 EntityDslFactory.eINSTANCE.createTrackBar()));
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.ATTRIBUTE__INPUT_TYPE,
				 EntityDslFactory.eINSTANCE.createCheckBox()));

		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.ATTRIBUTE__INPUT_TYPE,
				 EntityDslFactory.eINSTANCE.createComboBox()));

		newChildDescriptors.add
			(createChildParameter
				(EntityDslPackage.Literals.ATTRIBUTE__LABEL_TEXT,
				 EntityDslFactory.eINSTANCE.createLabel()));
	}
